...
class Document extends BaseDocument {
    ...
    static loadById(id, options){
        ...
        return this._wrapOneFromPromise(DB().loadById(this.collectionName(), id), populate);
    }

    static loadByIdAndUpdate(id, values, options){
        var populate = true;
        if (options && options.hasOwnProperty('populate')) {
            populate = options.populate;
        }

        return this._wrapOneFromPromise(DB().loadByIdAndUpdate(this.collectionName(), id, values, options), populate);
    }

    static loadByIdAndDelete(id, options){
        var populate = true;
        if (options && options.hasOwnProperty('populate')) {
            populate = options.populate;
        }

        return this._wrapOneFromPromise(DB().loadByIdAndDelete(this.collectionName(), id), populate);
    }
    ...
    static loadOne(query, options) {
        ...
        return this._wrapOneFromPromise(DB().loadOne(this.collectionName(), query), populate);
    }
    ...
    static loadOneAndUpdate(query, values, options) {
        ...
        return this._wrapOneFromPromise(DB().loadOneAndUpdate(this.collectionName(), query, values, options));
    }
    ...
    static _wrapFromPromise(promise){

    }

    static _wrapOneFromPromise(promise, populate){
        var that = this;
